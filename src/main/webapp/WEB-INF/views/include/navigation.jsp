				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown dropdown-slide">
						...
						<ul class="dropdown-menu">
							<li class="dropdown-header">내자리얌 입점카페 </li>
					...
					<li class="dropdown dropdown-slide">
						...
						<li class="dropdown-header">와글와글</li>
							...
							<li><a href="/review/list" style="font-size:20px;">이용후기</a></li>
						</ul>
					</li>
					<!-- /커뮤니티  -->
					...
					<li class="dropdown dropdown-slide">
						<a href="/" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350"
							role="button" aria-haspopup="true" aria-expanded="false" style="font-size:20px;">고객센터 <span
								class="tf-ion-ios-arrow-down"></span></a>
						<ul class="dropdown-menu">
